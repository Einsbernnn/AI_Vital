...
<body class="bg-gradient-to-r from-green-200 to-green-400 min-h-screen flex flex-col">
    ...
    <script>
    document.getElementById("quickSaveButton").addEventListener("click", async function (event) {
        ...
        try {
            ...
            const payload = {
                ...
                email,
                gender,
                age: age.replace(" years old", ""), // Remove "years old" if present
                height: height.replace(" cm", ""),  // Remove "cm" if present
                weight: weight.replace(" kg", ""),  // Remove "kg" if present
            ...
            // Send the data to store_reading.php
            ...
            if (result.success) {
                Swal.fire({
                    ...
                    window.location.href = "results2.php";
                });
            } else {
                Swal.fire({
                    icon: 'error',
