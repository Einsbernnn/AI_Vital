<?php
    ...
    $pdo = Database::connect();
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sql = "SELECT * FROM health_diagnosticswhere id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($id));
            ...
            <div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
                ...
                <form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="name" type="text"  placeholder="" value="<?php echo strtoupper($data['name']);?>" required pattern="[A-Z\s]+" title="Please enter capital letters only">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="mobile" type="text"  placeholder="" value="<?php echo $data['mobile'];?>" required pattern="\d{11}" title="Please enter exactly 11 digits">
                        </div>
                    </div>
                    
                    <div class="form-actions">
                        <button type="submit" class="btn btn-success">Update</button>
                        <a class="btn btn-danger" href="userdata2.php">Back</a>
                    </div>
                </form>
            </div>               
        </div> <!-- /container -->    
